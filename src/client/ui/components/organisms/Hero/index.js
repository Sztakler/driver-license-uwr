	...
	if (isDesktop) {
		return (
			<HeroContainer id="HeroContainer">
				<PanelContainer className="relative h-[calc(100vh-110px)]" id="panel-0">
					...
					<ImageContainer className="absolute bottom-16 flex justify-center w-full">
						<Button
							onClick={() => {
								scrollDown(1);
							}}
				...
				<PanelContainer className="relative h-[calc(100vh-110px)]" id="panel-1">
				...
				<PanelContainer className="relative h-[calc(100vh-110px)]" id="panel-2">
					<ImageContainer className="w-full h-full">
						<Image
							className="w-full h-full max-w-full block"
				...
				<PanelContainer className="relative h-[calc(100vh-110px)]" id="panel-3">
					<ImageContainer className="w-full h-[100%]">
						<Image
							className="w-full h-full max-w-full block"
