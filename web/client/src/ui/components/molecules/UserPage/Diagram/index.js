...
export default function Diagram() {
	...
	const [userKnowledgeCounts, setUserKnowledgeCounts] = useState({ high_count: 0, medium_count: 0, });
	...
	const data = {
		labels: ["Materiał nieopanowany", "Materiał do powtórki", "Materiał w pełni opanowany"],
		datasets: [
			{
