		...
		<LoginFormContainer onSubmit={handleSubmit}>
			...
			<InnerWrapper>
				...
				<InputSection>
					<Image
						...
						src={require("../../../../../../src/assets/images/mail.png")}
					/>
					<Input login id="usernameInput" type="text" value={usernameInput} onChange={handleUsername} placeholder="Username" />
			...
			<InnerWrapper>
				...
				<InputSection>
					...
					/>
					<Input login id="passwordInput" type="password" value={passwordInput} onChange={handlePassword} placeholder="******************" />
				</InputSection>
			</InnerWrapper>
