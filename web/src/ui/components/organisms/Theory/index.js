	...
	return (
		<Container className="relative">
			{isSidebarVisible ? (
				<SidebarContainer>
					<button
						className="absolute top-[16px] left-[330px] flex flex-col cursor-pointer"
					...
					>
						...
						<p className="rotate-90 translate-y-16 -translate-x-10">
							Zwiń spis treści
						</p>
						<input
							type="checkbox"
							className="appearance-none w-[60px] checked:bg-blue-500"
						></input>
					</button>
				...
				<button
					className="absolute top-[16px] left-[8px] flex flex-col cursor-pointer"
					onClick={handleSidebarClick}
				>
					<svg
					...
					<p className="rotate-90 translate-y-16 -translate-x-14">
						Rozwiń spis treści
					</p>
					<input
						type="checkbox"
			...
			<Content>
				...
				<Paragraph style="text-[#0d0d0d] max-w-prose text-lg text-left">
